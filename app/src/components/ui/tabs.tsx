...
function TabsIndicator({ className, ...props }: TabsPrimitive.Indicator.Props) {
  return (
    <TabsPrimitive.Indicator
      ...
      className={cn(
        'pointer-events-none absolute z-0 rounded-full bg-background shadow-xs transition-[translate,width,height] duration-200 ease-in-out',
        'top-0 left-0 h-[var(--active-tab-height)] w-[var(--active-tab-width)] translate-x-[var(--active-tab-left)] translate-y-[var(--active-tab-top)]',
        'dark:bg-input/30',
